...
RUN apk add zip unzip git curl libzip libzip-dev libpng libpng-dev libjpeg libjpeg-turbo libjpeg-turbo-dev freetype-dev icu-dev mariadb-client mariadb-connector-c openssh rsync
